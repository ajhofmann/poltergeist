  ...
  class Node {
    ...
    async mouseEvent(name) {
      ...
      if (test.status === 'success') {
        if (name === 'rightclick') {
          this.page.mouseEvent('click', pos, 'right');
          this.trigger('contextmenu');
        } else {
          this.page.mouseEvent(name, pos);
        }
        return pos;
      } else {
    ...
    async dragTo(other) {
      ...
      await this.page.mouseEvent('mousedown', pos);
      await new Promise(function(resolve) {
        return setTimeout(resolve, 200);
      });
      return (await this.page.mouseEvent('mouseup', other_pos));
    }
    ...
    async dragBy(x, y) {
      ...
      return this.page.mouseEvent('mousedown', position).then(() => {
        return this.page.mouseEvent('mouseup', final_pos);
      });
    }
